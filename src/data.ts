...
export const PROJECTS: Project[] = [
  {
    id: 'ai-tester',
    title: 'AI 测试用例生成器',
    description: '一个基于大语言模型的测试用例辅助生成工具，支持需求分析、边界场景补全、人工审核和导出功能。显著提升了测试设计的效率和覆盖率。',
    tags: ['JavaScript', 'API Integration', 'Web Components'],
...
### AI 的介入
通过集成大语言模型，我的工具可以读取需求文档（PRD），自动识别核心功能点，并生成包含正常路径、边界路径和异常路径的测试矩阵。这不仅节省了 60% 以上的初稿编写时间，更重要的是，它能基于 AI 的知识库，提醒我一些从未想过的特殊场景。
